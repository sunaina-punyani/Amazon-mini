...
<body>
	...
	<center>
  <?php
   $sql = "Select * from books natural join author where book_id=".$id;
  $row = mysqli_fetch_array($result);
   if($result = mysqli_query($dbc, $sql)){
     echo "<img src='../images_books/".$id.".jpg' style='width: 90%'>";
   }
  ?>
	 <!--<img src="../images/book_cover.jpg" style="width: 90%">-->
	 </center>
	</div>
	<div class="col s12 l7 ">

  <?php
     $sql = "Select * from books natural join author natural join Language where book_id=".$id;
...
if($result = mysqli_query($dbc, $sql)){
  ...
  ?>
	<hr><br>
<?php
  echo "<button id='btn".$id."' style='width: 20%; height: 60%;'>Paperback <br> &#8377;".$row['price']."</button><br><br>";
  ?>
  <h5><b>
  	Description
  </b></h5>
  <br>
  <!--
  <p>Given a set of rules and the promise of a generous compensation package at the end, can several hundred people govern themselves and live in relative harmony for six years?</p>
<p>
...
<p>
What isn’t clear is if they’ll make it out alive.</p>-->
<?php
 echo "<p>
   ".$row['description']."
 </p>";
...
<hr>
   ...
   <div class="col s4 l4">
   <?php
   echo "<p style='font-size: 0.8em'>Length: ".$row['pages']." pages </p>";
   ?>
   </div>

   <div class="col s4 l4">
   <p style="font-size: 0.8em">Word Wise: Enabled</p>
   </div>

    <div class="col s4 l4">
   <p style="font-size: 0.8em">Enhanced Typesetting: Enabled</p>
   </div>
    ...
    <div class="row">
   <div class="col s4 l4">
   <p style="font-size: 0.8em">Page Flip: Enabled</p>
   </div>

   <div class="col s4 l4">
   <?php
   echo "<p style='font-size: 0.8em'>Language: ".$row['language']."</p>";
   ?>
   </div>
 ...
 <div class="col s12 l2" style="margin-left: 7%;">
 <br><br>
	<a class="waves-effect waves-light btn" style="background-color: #FF9900"> <i class="material-icons">shopping_cart</i> Add to Cart</a>
	<br><br><br>
		<a class="waves-effect waves-light btn" style="background-color: #FF9900; width: 86%" href="template.php"> <i class="material-icons" >credit_card</i> Buy Now</a>
 </div>
...
Forbes Magazine has listed Amish amongst the 100 most influential celebrities in India, four years in a row. He has also received the Society Young Achievers Award for literature in 2013, Man of the Year by Radio City, Communicator of the Year by PR Council of India, Dainak Bhaskar Reader’s Choice Awards and Pride of India award (Literature). Amish was also selected as an Eisenhower Fellow, a prestigious American programme for outstanding leaders from around the world.
  ...
  <?php
   echo "<p>".$row['author_description']."</p>";
  ?>
	</center>
	</div>
</div>
...
<div class="col s11 l7">
 <br><h5>Top Customer Reviews</h5>
 <br>
 <a href="#" class="star" style="color: #FF9900">&star;</a>
 <a href="#" class="star" style="color: #FF9900">&star;</a>
 <a href="#" class="star" style="color: #FF9900">&star;</a>
 <a href="#" class="star" style="color: #FF9900">&star;</a>
 <a href="#" class="star" style="color: #FF9900">&star;</a>
